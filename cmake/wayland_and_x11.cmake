...
add_library(CanvasEngine-WaylandDeps INTERFACE)
add_library(CanvasEngine-X11Deps INTERFACE)
...
if (UNIX)
	...
	if (CANVAS_GRAPHICS_SUPPORT_WAYLAND)
		target_link_libraries(CanvasEngine-WaylandDeps
		INTERFACE
			wayland::client
		)
	endif ()
	...
	if (CANVAS_GRAPHICS_SUPPORT_X11)
		target_link_libraries(CanvasEngine-X11Deps
		INTERFACE
			X11::X11
			X11::Xrandr
			X11::xcb
